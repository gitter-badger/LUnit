...
namespace LUnit_Tests.LCore.LUnit.Markdown
{
    ...
    LUnit has Autogenerated 27 method stubs:
    */
    public partial class GitHubMarkdownTester : XUnitOutputTester, IDisposable
    {
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LUnit)+ "." + nameof(global::LCore.LUnit.Markdown)+ "." + nameof(GitHubMarkdown)+ "." + nameof(GitHubMarkdown.Table) + "(String[,], Boolean)")]
        public void Table()
        {
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LUnit)+ "." + nameof(global::LCore.LUnit.Markdown)+ "." + nameof(GitHubMarkdown)+ "." + nameof(GitHubMarkdown.Table) + "(IEnumerable<IEnumerable<String>>, Boolean)")]
        public void Table()
        {
            // TODO: Implement method test LCore.LUnit.Markdown.GitHubMarkdown.Table
        }
