...
namespace LUnit_Tests.LCore.LUnit
{
    ...
    public partial class TestExtTester : XUnitOutputTester, IDisposable
    {
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LUnit)+ "." + nameof(TestExt)+ "." + nameof(TestExt.GetAssemblyMemberTraits) + "(IEnumerable<Assembly>) => Dictionary<MethodInfo, List<String>>")]
